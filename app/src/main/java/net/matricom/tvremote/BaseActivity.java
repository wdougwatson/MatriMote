...
import net.matricom.tvremote.ConnectionManager.ConnectionListener;
import net.matricom.tvremote.TrackballHandler.Direction;
import net.matricom.tvremote.TrackballHandler.Listener;
